...
var $Boo_show : Boolean
var $Lon_parameters; $Lon_x : Integer
var $Dir_preferences; $Dom_item; $Dom_report; $Dom_root; $File_preferences; $Txt_action : Text
var $Txt_databaseName; $Txt_item : Text
...
$Dir_preferences:=Get 4D folder:C485(Active 4D Folder:K5:10)+$Txt_databaseName+Folder separator:K24:12

CREATE FOLDER:C475($Dir_preferences; *)

$File_preferences:=$Dir_preferences+"mess.4DPreferences"
