...
Case of 
	...
	: ($Lon_page=1)
		...
		If ($Boo_activated)
			...
			OBJECT SET RGB COLORS:C628(*; "field.label"; Foreground color:K23:1; Background color none:K23:10)
		...
		Else 
			...
			OBJECT SET RGB COLORS:C628(*; "field.label"; OB Get:C1224(<>label_params; "disabledTextColor"; Is longint:K8:6); Background color none:K23:10)
