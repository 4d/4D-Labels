...
var $Mnu_format; $Txt_buffer; $Txt_columnFormat : Text
...
Case of 
	...
	: ($Lon_type=Is integer:K8:5)\
		...
		Repeat 
			...
			$Txt_buffer:=Localized string:C991("number_"+String:C10($Lon_i))
	...
	: ($Lon_type=Is date:K8:7)
		...
		Repeat 
			...
			$Txt_buffer:=Localized string:C991("date_"+String:C10($Lon_i))
	...
	: ($Lon_type=Is time:K8:8)
		...
		Repeat 
			...
			$Txt_buffer:=Localized string:C991("time_"+String:C10($Lon_i))
	...
	: ($Lon_type=Is boolean:K8:9)
		...
		Repeat 
			...
			$Txt_buffer:=Localized string:C991("boolean_"+String:C10($Lon_i))
	...
	: ($Lon_type=Is picture:K8:10)
		...
		Repeat 
			...
			$Txt_buffer:=Localized string:C991("pict_"+String:C10($Lon_i))
	...
	: ($Lon_type=Is text:K8:3)\
		...
		Repeat 
			...
			$Txt_buffer:=Localized string:C991("alpha_"+String:C10($Lon_i))
