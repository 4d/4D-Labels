...
var $Lon_i; $Lon_parameters; $Lon_value : Integer
var $Mnu_parentMenu; $Mnu_sub : Text
...
For ($Lon_i; 0; 9; 1)
	...
	Else 
		...
		APPEND MENU ITEM:C411($Mnu_sub; Replace string:C233(Localized string:C991("Menus_width_N"); "{n}"; String:C10($Lon_i)))
