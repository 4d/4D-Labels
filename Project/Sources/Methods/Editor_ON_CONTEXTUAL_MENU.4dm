...
var $Boo_createMenu; $Boo_isImage; $Boo_isImageOnly; $Boo_rect; $Boo_round_rect; $Boo_withFill : Boolean
var $Boo_withStroke; $Boo_withText : Boolean
var $Lon_buffer; $Lon_objectCount; $Lon_parameters; $Lon_selCount : Integer
var $Dom_canvas; $Dom_label; $Mnu_buffer; $Mnu_pop; $Txt_buffer; $Txt_parameter : Text
var $Txt_preserveAspectRatio : Text
var $Obj_inventory : Object
	...
	If ($Lon_selCount>0)
		...
		If ($Boo_rect | $Boo_round_rect)
			...
			If ($Boo_round_rect)
				...
				APPEND MENU ITEM:C411($Mnu_pop; Localized string:C991("Menus_rect"))
			...
			If ($Boo_rect)
				...
				APPEND MENU ITEM:C411($Mnu_pop; Localized string:C991("Menus_roundRect"))
