...
If ((OBJECT Get pointer:C1124(Object named:K67:5;"automatic_resizing"))->=1)
	...
	OBJECT SET RGB COLORS:C628(*;"size.width.@";$Lon_disabledTextColor;Background color:K23:2)
	OBJECT SET RGB COLORS:C628(*;"size.height.@";$Lon_disabledTextColor;Background color:K23:2)
...
Else 
	...
	OBJECT SET RGB COLORS:C628(*;"size.width.@";Foreground color:K23:1;Background color:K23:2)
	OBJECT SET RGB COLORS:C628(*;"size.height.@";Foreground color:K23:1;Background color:K23:2)
