...
// ----------------------------------------------------
xml_GET_ATTRIBUTE_BY_NAME($Dom_node; "temp-id"; ->$Txt_ID)

If (Length:C16($Txt_ID)>0)
	
	DOM REMOVE XML ATTRIBUTE:C1084($Dom_node; "temp-id")
...
Repeat 
	...
	If ($Lon_x>0)
		...
		DOM_ELEMENT_RESTORE_ID($tDom_childs{$Lon_x})  //----------- RECURSIVE
