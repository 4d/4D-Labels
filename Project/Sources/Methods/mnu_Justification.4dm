...
APPEND MENU ITEM:C411($Mnu_menuReference;Get localized string:C991("menu_align_left"))
...
APPEND MENU ITEM:C411($Mnu_menuReference;Get localized string:C991("menu_align_center"))
...
APPEND MENU ITEM:C411($Mnu_menuReference;Get localized string:C991("menu_align_right"))
...
APPEND MENU ITEM:C411($Mnu_menuReference;Get localized string:C991("menu_align_default"))
