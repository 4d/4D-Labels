//%attributes = {}
  // ----------------------------------------------------
  // Project method: HDI_MESSAGE
  // ID[958BFDC51F7440E18BB1ED53580612E9]
...
Case of 
	...
	: ($Txt_entryPoint="_run")
		...
		HDI_MESSAGE ("_declarations")
		HDI_MESSAGE ("_init")
		
		$Win_hdl:=Open form window:C675("HDI_MESSAGE";Plain form window:K39:10;Horizontally centered:K39:1;Vertically centered:K39:4;*)
		DIALOG:C40("HDI_MESSAGE")
		CLOSE WINDOW:C154
