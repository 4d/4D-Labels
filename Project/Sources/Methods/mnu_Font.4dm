...
var $Lon_i; $Lon_parameters; $Lon_size : Integer
var $Mnu_hdl : Text
...
For ($Lon_i; 1; $Lon_size; 1)
	...
	If ($tTxt_recentFonts{$Lon_i}=".@")
		...
		$tTxt_recentFonts{$Lon_i}:=Localized string:C991("systemFont")
...
For ($Lon_i; 1; $Lon_size; 1)
	...
	If ($tTxt_favoriteFonts{$Lon_i}=".@")
		...
		$tTxt_favoriteFonts{$Lon_i}:=Localized string:C991("systemFont")
...
APPEND MENU ITEM:C411($Mnu_hdl; Localized string:C991("menu_show_fonts"))
