...
var $Lon_field; $Lon_parameters; $Lon_table : Integer
var $Ptr_fieldPointer : Pointer
var $Txt_expression; $Txt_field; $Txt_table : Text
...
If (Match regex:C1019("\\[([^]]+)\\](.+)"; $Txt_expression; 1; $tLon_positions; $tLon_lengths))
	...
	If (Asserted:C1132(Last table number:C254#0))
